...
def main():
    ...
    for epoch in range(num_epochs):
        ...
        if test_acc > best_acc:
            best_acc = test_acc
            save_path = os.path.join(os.path.dirname(__file__), 'best_transformer_cifar10.pth')
    ...
    print(f'Model saved to: {os.path.join(os.path.dirname(__file__), "best_transformer_cifar10.pth")}')
